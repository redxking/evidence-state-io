...
| P1-05 | Multi-source composition | P1-01, one adapter | Overlap cannot inflate coverage; unknown overlap is conservative; contradictions remain explicit. | [ADR-0015](adr/0015-multi-source-composition.md) drafted and Proposed; owner decision outstanding |
